        ...
        <div className="grid max-w-screen-xl grid-cols-1 gap-10 pt-10 mx-auto mt-5 border-t border-gray-100 dark:border-trueGray-700 lg:grid-cols-5">
          <div className="lg:col-span-2">
            <div>
              ...
              >
                <img
                  src="https://edge.yancey.app/beg/e8t5s040-1685018596013.png"
                  className="w-8"
                />
          ...
          <div>
            <div className="flex flex-wrap w-full -mt-2 -ml-3 lg:ml-0">
              <Link
                href="https://yanceyleo.com/legal/privacy-policy"
                className="w-full px-4 py-2 text-gray-500 rounded-md dark:text-gray-300 hover:text-indigo-500 focus:text-indigo-500 focus:bg-indigo-100 focus:outline-none dark:focus:bg-trueGray-700"
              >
                Privacy Policy
              </Link>
          ...
          <div className="">
            ...
            <div className="flex mt-5 space-x-5 text-gray-400 dark:text-gray-500">
              ...
              <a
                href="https://www.facebook.com/yancey.leo.79/"
                target="_blank"
                rel="noopener"
              >
              ...
              <a
                href="https://www.instagram.com/yanceyofficial"
                target="_blank"
                rel="noopener"
              >
...
const Backlink = () => {
  return (
    ...
    >
      ...
      <span>Powered by Web3Templates</span>
    </a>
  );
};
